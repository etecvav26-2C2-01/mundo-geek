...
(7, 'Teclado Mecânico Anime — Edição Especial', 'Um teclado feito para quem quer transformar o setup em algo único. O visual inspirado na estética de anime, combinado com iluminação RGB e teclas personalizadas, faz dele muito mais do que um periférico: é uma peça de destaque para sua mesa.', 299.90, 'product_6ab40c1a4dcc56.08312795.png', 14, '2026-09-23 17:27:54', 0.850, 4, 35.5, 13)
