...
$group1 = array_chunk($featuredProducts, 1);
$group2 = array_chunk($featuredProducts, 2);
$group3 = array_chunk($featuredProducts, 4);
...
<section class="container py-4">
  ...
  <div id="carousel1" class="carousel slide d-block d-sm-none" data-bs-ride="false">
    <div class="carousel-inner">
      <?php foreach ($group1 as $index => $group): ?>
  ...
  <div id="carousel2" class="carousel slide d-none d-sm-block d-lg-none" data-bs-ride="false">
    <div class="carousel-inner">
      <?php foreach ($group2 as $index => $group): ?>
        <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
  ...
  <div id="carousel3" class="carousel slide d-none d-lg-block" data-bs-ride="false">
    <div class="carousel-inner">
      <?php foreach ($group3 as $index => $group): ?>
        <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
