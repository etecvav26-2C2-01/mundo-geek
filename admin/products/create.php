        ...
        <div class="card-body">
            <form action = "store.php" method = "post" enctype = "multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="number" id="price" name = "price" step ="0.01" min = "0" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="number" id="height" name = "height" min = "0" step="0.001" required>
                </div>
                <div class="mb-3">
                    <label for="weight" class="form-label"><?= $text['weight'] ?></label>
                    <input class="form-control" type="number" id="weight" name = "weight" min = "0" step="0.001" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="image" name = "image" accept="image/png, image/jpeg, image/jpg, image/webp" required>
                </div>
